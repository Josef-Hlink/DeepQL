...
def main():
    ...
    for _ in range(50):
        ...
        pass
    # Now we can pass a title to the prog function, and it will print a progress bar
    # if verbose is set to true, otherwise it will only print the title and run times
